...
//                        (every type: density; agent-list: sort, preset, focus, recap, recap_open,
...
function readDensity(file, prefix, table, errors) {
  var scoped = []
  var value = pick(file, "density", table, DensityPolicy.SETTINGS, DensityPolicy.DEFAULT_SETTING, scoped)
...
function readAgentList(file, prefix, table, errors) {
  ...
  settings.density = readDensity(file, prefix, table, errors)
