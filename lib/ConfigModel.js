...
function defaultAgentList() {
  return { type: "agent-list", sort: SortPolicy.DEFAULT_MODE, preset: CardPolicy.DEFAULT_PRESET, focus: "herdr",
    recap: RecapModel.DEFAULT_MODE, recapOpen: RecapModel.DEFAULT_OPEN, weight: DEFAULT_WEIGHT }
}
...
function readAgentList(file, prefix, table, errors) {
  ...
  unknownKeys(file, prefix, table, COMMON_MODULE_KEYS.concat(["sort", "preset", "focus", "recap", "recap_open"]), errors)
